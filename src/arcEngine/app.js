...
function postToSystem(type, payload) {
  ...
  window.parent.postMessage(
    { source: "arc-character-archives", type, payload },
...
window.addEventListener("message", (event) => {
  const trustedParentOrigin = window.parent === window ? window.location.origin : window.parent.location.origin;
  if (event.origin !== trustedParentOrigin || !event.data || typeof event.data !== "object") return;
