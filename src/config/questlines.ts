...
export const COMPANION_QUESTLINES: CompanionQuestlineDefinition[] = [
  ...
  {
    id: 'haven-shelter-without-stagnation',
    companionId: 'haven',
    title: 'Shelter Without Stagnation',
    subtitle:
      'Learn recovery that protects momentum, accountability that preserves dignity, and balance that can last.',
    premise:
      'Haven’s shelter is not a hiding place. It is somewhere to recover enough truth, safety, and capacity to keep moving without turning growth into self-punishment.',
    ...
    chapters: [
      {
        ...
        rewardXp: 100,
        intro:
          'Haven begins by asking what helps the nervous system understand that a difficult day is not an emergency verdict.',
        completionMessage:
          '“You built enough safety to tell the truth. Now the next step can be chosen instead of forced.” — Haven',
        objectives: [
          tracked(
            'haven-1-character',
            'Practice two caring choices',
            'Complete two Character missions.',
            'category-count',
            2,
            'character',
          ...
          manual(
            'haven-1-ground',
            'List your stabilizers',
            'Name three small things that make a hard day safer or gentler.',
            'What reliably helps you return to yourself?',
          ),
        ],
      },
      {
        ...
        number: 2,
        title: 'Humane Accountability',
        rewardXp: 140,
        intro:
          'The Guardian keeps the facts and removes the cruelty. Review what happened, protect the lesson, and refuse identity-level condemnation.',
        completionMessage:
          '“Accountability remained honest after shame left the room. That is the version that can teach you.” — Haven',
        objectives: [
          tracked(
            'haven-2-character',
            'Four whole-person actions',
          ...
          manual(
            'haven-2-review',
            'Rewrite a harsh verdict',
            'Turn one self-attacking conclusion into facts, impact, and a next repair.',
            'What happened when you kept accountability but removed contempt?',
          ),
        ],
      },
      {
        ...
        number: 3,
        title: 'The Shape of Shelter',
        rewardXp: 180,
        intro:
          'Shelter needs walls and doors. Haven asks where a boundary can protect recovery, attention, or dignity without becoming isolation.',
        completionMessage:
          '“A boundary is not always a rejection. Sometimes it is the shape that lets care remain honest.” — Haven',
        objectives: [
          tracked(
            'haven-3-character',
            'Practice five protected choices',
            'Complete five Character missions.',
            'category-count',
            5,
            'character',
          ),
          ...
          manual(
            'haven-3-boundary',
            'Name one boundary',
            'Write a boundary that protects your capacity without punishing anyone.',
            'What clear, kind limit would help you remain whole?',
          ),
        ],
      },
      {
        id: 'haven-4-reentry',
        number: 4,
        title: 'Re-entry Without Punishment',
        rewardXp: 220,
        intro:
          'After recovery comes movement. Haven designs a re-entry point small enough to repeat and meaningful enough to rebuild trust.',
        completionMessage:
          '“You did not repay the missed time with pain. You simply resumed the relationship with your own life.” — Haven',
        objectives: [
          tracked(
            'haven-4-missions',
            'Six gentle proofs',
          ...
          manual(
            'haven-4-plan',
            'Write the low-capacity plan',
            'Define what a successful low-energy day looks like.',
            'What minimum keeps the campaign connected without draining you?',
          ),
        ],
      },
      {
        id: 'haven-5-whole',
        number: 5,
        title: 'Guardian of the Whole',
        rewardXp: 300,
        intro:
          'Haven’s final lesson is that the campaign is not successful if it reaches the goal by abandoning the person who wanted it.',
        completionMessage:
          '“You are not cargo being dragged toward progress. You are the life the progress was meant to serve.” — Haven',
        objectives: [
          tracked(
            'haven-5-character',
          ...
          manual(
            'haven-5-charter',
            'Write the whole-person charter',
            'Choose three rules that protect health, dignity, and lasting progress.',
            'What must remain true even during an ambitious season?',
          ),
        ],
      },
    ],
