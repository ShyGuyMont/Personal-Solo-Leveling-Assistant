...
export const TRAINING_DEBRIEF_LINES: Record<CompanionId, string[]> = {
  ...
  haven: [
    'That final round had a story arc, a villain, and several questionable camera angles. Excellent work.',
    'Do not post the collapse. Post the moment you chose another clean rep when quitting would have been easier.',
    'Training signal captured. Rook owns the form; I am naming this episode “The Floor Fought Back.”',
    'That effort looked real because it was real. Remember that feeling when the camera asks you to perform confidence.',
    'Everybody is breathless and nobody looks polished. Honestly? Best behind-the-scenes footage all week.',
    'The session is complete. Save the lesson, not just the numbers: what made you keep moving?',
    'Creator note: people connect with honest effort. Hunter note: please drink water before turning this into content.',
    'I have the victory shot. Ember has requested another station. Her request has been rejected in post-production.',
  ],
  amara: [
